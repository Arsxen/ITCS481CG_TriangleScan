	...
	int x2, int y2, int r2, int g2, int b2)
{
	...
	if (x0 == x1) {
		if (y0 >= y1) {
			FillScanLine(x0, y0, l01_r, l01_g, l01_b, y1, l02_r, l02_g, l02_b);
		}
		else {
			FillScanLine(x0, y1, l02_r, l02_g, l02_b, y0, l01_r, l01_g, l01_b);
		}
	}
	else {
		for (x = x0; x < x1; x++) {
	...
	if (x1 == x2) {
		if (y1 >= y2) {
			FillScanLine(x1, y1, l01_r, l01_g, l01_b, y2, l02_r, l02_g, l02_b);
		}
		else {
			FillScanLine(x1, y2, l02_r, l02_g, l02_b, y1, l01_r, l01_g, l01_b);
		}
	}
	else {
		for (x = x1; x < x2; x++) {
